...
contract ReksadanaTest is Test {
    ...
    function setUp() public {
        vm.createSelectFork("https://arb-mainnet.g.alchemy.com/v2/JNO4ojiS0GbXZimXOBWO1Ji4KKXWxtWo", 335104419);
    ...
    function test_deposit() public {
        deal(usdc, address(this), 1000e6); // 1000 USDC ke dalam Reksadana
